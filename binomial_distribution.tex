...
The mean of the binomially distributed random variable $\Bs[n]$ is $np$ and its variance is $npq$ \cite[pp. 8-9]{fels}. Therefore we get after standardizing $\Bs[n]$ the following random variable

...
\newcommand*{\includewrapfig}[4][0.33\textwidth]{\begin{wrapfigure}{R}{#1} \vspace{-20pt} \begin{center} \includegraphics[width=#1 - 0.02\textwidth,draft=false]{figures/{#2}} \caption[#4]{#3} \end{center} \vspace{-30pt} \end{wrapfigure}}

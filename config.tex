...
\newcommand*{\includefig}[4][0.5\textwidth]{\begin{figure}[h] \begin{center} \includegraphics[width={#1},draft=false]{figures/{#2}} \caption[#4]{#3} \end{center} \end{figure}}
\newcommand*{\includewrapfig}[4][0.33\textwidth]{\begin{wrapfigure}{R}{#1} \vspace{-10pt} \begin{center} \includegraphics[width=#1 - 0.02\textwidth,draft=false]{figures/{#2}} \caption[#4]{#3} \end{center} \vspace{-15pt} \end{wrapfigure}}

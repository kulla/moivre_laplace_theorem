...
\newcommand*{\includewrapfig}[2]{\begin{wrapfigure}{r}{0.33\textwidth} \vspace{-20pt} \begin{center} \includegraphics[width=0.3\textwidth,draft=false]{figures/{#1}} \caption{#2} \end{center} \vspace{-30pt} \end{wrapfigure}}

...
\begin{proof}
  Let $\seq{c_n}$ be a sequence with $\seq{c_nh}\in\littleo{1}$ and $\lim_{n\to\infty} c_n=\infty$ (e.g. $c_n =\sqrt[4]{n}$). We split the sum $\sum_{a \le \x \le b} \bb{\x}$ into two sums:

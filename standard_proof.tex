...
\begin{proof}
  ...
  The second sum can be approximated as in the proof of the first global version of the de Moivre-Laplace theorem. Because $\abs{\x} \le \max\{\abs{c_n},\abs{z}\} \in \littleo{\frac 1h}$ we can apply the local version of de Moivre-Laplace and get
  \begin{align}

...
\begin{proof}
  ...
  \begin{align}
    ...
    & \in \frac 1{\ean[\bigpsi{pCh}]{q}^2} + \frac 1{\ean[\bigpsi{qCh}]{p}^2} \bnl
    & = \ean[\bigpsi{2pCh}]{\frac 1{q^2}} + \ean[\bigpsi{2qCh}]{\frac 1{p^2}} \nl
    &
    \begin{comment}
      a := \max\{ p, q \}
    \end{comment} \nl
    & \subseteq \ean[\bigpsi{2aCh}]{\frac{1}{q^2}} + \ean[\bigpsi{2aCh}]{\frac 1{p^2}} \nl
    & = \ean[\bigpsi{2aCh}]{\frac 1{p^2}+\frac 1{q^2}} \nl
    & = \ean[\bigpsi{2aCh}]{\frac {p^2+q^2}{p^2q^2}} \nl
    & \forallrel{\le} \frac {p^2+q^2}{p^2q^2} e^{\bigpsi{2aCh}} \nl
    & \begin{comment}

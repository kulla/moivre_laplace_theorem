...
\begin{proof}
  ...
  \begin{align}
    \begin{array}{rrl}
      & \abs{\x} & \le \bigpsi{C} \nl
      \implies & \abs{\frac{k-np}{\sqrt{npq}}} & \le \bigpsi{C} \nl
      \implies & \abs{k-np} & \le \bigpsi{C\sqrt{npq}} \nl
      \implies & \abs{\frac k{np}-1} & \le \bigpsi{\frac{C\sqrt{q}}{\sqrt{np}}} \nl
      && \begin{comment}
       \abs{\frac ab-1} \le \epsilon \implies a \in \ean[\epsilon]{b}
      \end{comment} \nl
      \implies & k & \in \ean[\bigpsi{\frac{C\sqrt{q}}{\sqrt{np}}}]{np} \nl
  ...
  \begin{align}
    \begin{array}{rrl}
      & \abs{\x} & \le \bigpsi{C} \nl
      \implies & \abs{\frac{k-np}{\sqrt{npq}}} & \le \bigpsi{C} \nl
      \implies & \abs{np-k} & \le \bigpsi{C\sqrt{npq}} \nl
      \implies & \abs{n-k-nq} & \le \bigpsi{C\sqrt{npq}} \nl
      \implies & \abs{\frac {n-k}{nq}-1} & \le \bigpsi{\frac{C\sqrt{p}}{\sqrt{nq}}} \nl
      && \begin{comment}
       \abs{\frac ab-1} \le \epsilon \implies a \in \ean[\epsilon]{b}
      \end{comment} \nl
      \implies & k & \in \ean[\bigpsi{\frac{C\sqrt{p}}{\sqrt{nq}}}]{nq} \nl

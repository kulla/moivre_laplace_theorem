...
\begin{theorem}
  ...
  \begin{align}
    ...
    & \in \int_{-\infty}^z \fphi{t} \d{t} + \frac{q-p}6 \br{z^2-1}\fphi{z} h + \bigabs{\snorm{\phi}h} + \littleo{h}
  \end{align}
\end{theorem}
...
\begin{proof}
  ...
  \begin{align}
    ...
    \end{comment} \bnl
    &\subseteq \int_{c_n}^z \fphi{t} \d{t} + \bigabs{\snorm{\phi} h} + \littleo{h}
  \end{align}
  So we can summarize
  \begin{align}
    ...
    \begin{comment}
      \begin{aligned}
        \sum_{c_n \le \x \le z} \fphi{\x} h &\in \int_{c_n}^z \fphi{t} \d{t} + \bigabs{\snorm{\phi} h} + \littleo{h} \bnl
      ...
      \end{aligned}
    \end{comment} \bnl
    & \subseteq \int_{c_n}^z \fphi{t} \d{t} + \frac{q-p}6 \br{z^2-1}\fphi{z} h + \bigabs{\snorm{\phi}h} + \littleo{h}
  \end{align}
  ...
  \begin{align}
    ...
    & \in \int_{t < c_n} \fphi{t} \d{t} + \int_{c_n}^z \fphi{t} \d{t} + \frac{q-p}6 \br{z^2-1}\fphi{z} h + \bigabs{\snorm{\phi}h} + \littleo{h} \bnl
    & \in \int_{-\infty}^z \fphi{t} \d{t} + \frac{q-p}6 \br{z^2-1}\fphi{z} h + \bigabs{\snorm{\phi}h} + \littleo{h}
  \end{align}
\end{proof}
